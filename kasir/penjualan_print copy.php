	...
	<head>
		...
		<title>Cetak invoice - Raja Laut Indonesia</title>
		...
		<style>
			...
			td {
				font-size: 10px;
				/* Adjust the font size for table elements */
			}
			...
			td {
				font-size: 8px;
				/* Adjust the font size for headings and bold text */
			}
		</style>
	...
	<body style="padding: 10px;">
		<div id="content-wrapper"> <!-- Add a content wrapper div -->
