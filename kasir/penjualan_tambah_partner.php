...
<script>
        function autoPopulate() {
            ...
            var modifiedValue = inputValue + " Partner";
...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a href="penjualan_tambah.php" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> &nbsp; INPUT PENJUALAN ECER</a>
    <a href="penjualan_tambah_partner.php" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> &nbsp; INPUT PENJUALAN GROSIR</a>
    ...
    <div class="row">
      <section class="col-lg-12">       
        <div class="box box-info">
             ...
             <div class="row">
              ...
              <div class="col-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="pelanggan" name="pelanggan" required="required" placeholder="Masukkan Nama Pelanggan .. (Wajib)" >
                              ...
                              <tbody>
                                ...
                                while($d = mysqli_fetch_array($data)){
                                  ...
                                  <tr>
                                    ...
                                    <td width="20%" class="text-center"><?php echo "Rp.".number_format($d['produk_harga_jual_partner']).",-"; ?></td>
                                    ...
                                    <td width="1%">              
                                      ...
                                      if($d['produk_stok'] > 0){
                                        ...
                                        <input type="hidden" id="harga_<?php echo $d['produk_id']; ?>" value="<?php echo $d['produk_harga_jual_partner']; ?>">
          ...
          <br>
          <div class="form-group">
            <a href="penjualan_tambah_partner.php" class="btn btn-danger"><i class="fa fa-close"></i> Batalkan Transaksi</a>
            <button class="btn btn-success pull-right"  onclick="autoPopulate()" ><i class="fa fa-check"></i> Buat Transaksi</button>
          </div>
...
<script>
var input = document.getElementById("pelanggan");

input.addEventListener("input", function() {
    var value = input.value;
    
    if (value.trim() !== "") {
        input.value = value + " Partner";
    }
});
</script>
